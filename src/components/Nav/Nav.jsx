...
function Nav({ toggleSearch, handleSort }) {
  const navStyles = {
    ...
    container:
      "tracking-wide bg-green-900/5 font-mono text-sm flex flex-row lg:flex-col mt-1 lg:mt-2 px-2 lg:pt-2 text-left border-t border-b border-green-900 w-full 2xl:w-[3vw] lg:w-[5vw] lg:h-[85vh]",
