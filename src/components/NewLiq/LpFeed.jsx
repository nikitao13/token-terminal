...
function LpFeed() {
  ...
  const tableStyles = {
    container:
      "overflow-hidden text-green-500 py-0 border-t lg:border-l lg:border-b mt-0 lg:mt-2 border-green-900 bg-black lg:bg-green-900/5 flex flex-col lg:flex-row font-mono h-[48vh] lg:h-[80vh] 2xl:h-[60vh]",
